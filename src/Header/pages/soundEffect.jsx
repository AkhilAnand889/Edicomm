...
import {Button,Form,FormControl,Card,Collapse} from 'react-bootstrap'
import {BrowserRouter as Router, Link,Routes,Route,useNavigate} from'react-router-dom'
import First from './first'
import Music from './musichead'
    ...
    <div className='kui1'>
         <div className='dir'>
          <div className='dir2'>
            ...
            <h5 className='head11'><Link to={'/valentines'} style={{ color: 'white' }}>Valentines Day</Link></h5>
            <h5 className='head4'><Link to={'/new'} style={{ color: 'white' }}>New Year</Link></h5>
