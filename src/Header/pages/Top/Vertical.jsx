  ...
  return (
    <div>
      ...
      <h5 className='head5'><Link to={'/vertical'}  style={{ color: 'white' }}>Vertical</Link></h5>
       ...
       <img className='ima3' src="https://wallpapercave.com/wp/wp4727915.jpg" alt=""  diabled/>
        <Card.Body>
      ...
      <br />
      <Card xs={1} md={2} className="g-4">
       <img className='ima3' src="https://c4.wallpaperflare.com/wallpaper/479/876/54/auto-night-white-neon-wallpaper-preview.jpg" alt="" />
        <Card.Body>
        <button className='play'>Download</button> 
        <button className='plays'>Play</button> 
          <Card.Text>
