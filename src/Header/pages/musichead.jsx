...
import './musichead.css'
import  { useState } from 'react';
import {Button,Form,FormControl,Card,Modal} from 'react-bootstrap'
  ...
  return (
    <div>
         <div className='dir'>
          ...
          <div>
            <img className='good' src="https://thumbs.gfycat.com/FlickeringVictoriousJerboa-max-1mb.gif" alt="" />
       ...
       <img className='ima3' src="https://thumbs.gfycat.com/FeminineMistyGlowworm-max-1mb.gif" alt=""  diabled/>
        <Card.Body>
