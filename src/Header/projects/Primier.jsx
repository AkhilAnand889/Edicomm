  ...
  return (
    <div className='kui1'>
      ...
      <h5 className='head5'><Link to={'/vertical'}  style={{ color: 'white' }}>Vertical</Link></h5>
          ...
          <div>
            <img className='goodse' src="https://helpx.adobe.com/content/dam/help/en/premiere-pro/using/video-effects-transitions/videoeffectsandtransitions.png.img.png" alt="" />
