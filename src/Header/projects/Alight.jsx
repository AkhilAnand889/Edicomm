...
import {Card,Form,Modal,Button,FormControl} from'react-bootstrap'
function Alight() {
  ...
  return (
      ...
      <h5 className='head5'><Link to={'/vertical'}  style={{ color: 'white' }}>Vertical</Link></h5>
          ...
          <div>
            <img className='goodse' src="https://support.alightcreative.com/hc/article_attachments/360035030771/sstarex.gif" alt="" />
       ...
       <img className='ima3' src="https://s3.amazonaws.com/pbblogassets/uploads/2017/02/Step-1.gif" alt=""  diabled/>
        <Card.Body>
      ...
      <br />
      <Card xs={1} md={2} className="g-4">
       <img className='ima3' src="https://community.adobe.com/legacyfs/online/892686_animation_sm.gif" alt="" />
        <Card.Body>
        <button className='play'>Download</button> 
        <button className='plays'>Play</button> 
          <Card.Text>
      ...
      <div>
      <Card xs={1} md={2} className="g-4">
       <img className='ima3' src="https://s3.amazonaws.com/pbblogassets/uploads/2016/11/Create-Export-Presets-in-Adobe-Premiere-Pro.gif" alt="" />
        <Card.Body>
        <button className='play'>Download</button> 
        <button className='plays'>Play</button> 
          <Card.Text>
      ...
      <div>
      <Card xs={1} md={2} className="g-4">
       <img className='ima3' src="https://www.soundsnap.com/blog/wp-content/uploads/2018/03/Zoom-to-Sequence.gif" alt="" />
        <Card.Body>
        <button className='play'>Download</button> 
        <button className='plays'>Play</button> 
          <Card.Text>
      ...
      <div className='u1'>
      <Card xs={1} md={2} className="g-4">
       <img className='ima3' src="https://easyedit-s-upload.s3.eu-central-1.amazonaws.com/Hv_Ic38e_S_dcdac190ee.gif" alt="" />
        <Card.Body>
        <button className='play'>Download</button> 
        <button className='plays'>Play</button> 
          <Card.Text>
      ...
      <div className='hf'>
      <Card xs={1} md={2} className="g-4">
       <img className='ima3' src="https://premiereprotricks.com/wp-content/uploads/2021/10/video-cllip-border-14.gif" alt="" />
        <Card.Body>
        <button className='play'>Download</button> 
        <button className='plays'>Play</button> 
          <Card.Text>
      ...
      <div className='h18'>
      <Card xs={1} md={2} className="g-4">
       <img className='ima3' src="https://thumbs.gfycat.com/FeminineMistyGlowworm-max-1mb.gif" onMouseEnter={() => setIsPaused(true)}
      onMouseLeave={() => setIsPaused(false)}  style={{
            animationPlayState: isPaused ? 'paused' : 'running',}} alt="" />
        <Card.Body>
        <button className='play'>Download</button> 
        <button className='plays'>Play</button> 
          <Card.Text>
      ...
      <br />
      <br />
      <Button className='top20' variant="primary" onClick={() => setShow(true)}>
        EdiComm
      </Button>
      <Modal
        show={show}
      ...
      <h3 className='thank'>Thanks For Viewing My Website</h3>
      <hr />
     </div>
